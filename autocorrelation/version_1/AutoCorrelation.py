...
class AutoCorrelation:
    ...
    def fileFormatValidating(self):
        ...
        if not self.knowledgesourcefilepath.endswith('.pdf') and not self.knowledgesourcefilepath.endswith('.txt'):
            # 这种情况下，属于非法格式，返回false
            print 'Knowledge 文件格式错误，只允许是pdf和txt。'
            return False
    ...
    def questionAndKnowledge(self):
        ...
        :return: 
        """
        aq = AssociateQKV4.AssociateQKByKeyword()
    ...
    def batchProcessAssociate1(self):
        ...
        srcrootpath = './../data/course-knowledge-src'
        tgtrootpath = './../data/course-knowledge-tgt'
        ...
        for f in filelist:
            ...
            self.knowledgetargetfilepath = tgtrootpath + '/' + f
