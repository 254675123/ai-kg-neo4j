...
program       : *_* push knowledge to database *_*
...
class KnowledgePusher:
    """
    push knowledge data to dababase.
    """
    ...
    def __init__(self):
        ...
        """
        # saver
        self.knowledge_saver = KnowledgeSaver.KnowledgeSaver()
