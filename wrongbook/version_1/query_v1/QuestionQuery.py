...
class QuestionQuery(BaseQuery):
    ...
    def __init__(self):
        ...
        """
        super(QuestionQuery, self).__init__()
        self.cyther = QuestionCypher.QuestionCypher()
    ...
    def executeQuery(self, queryparam):
        ...
        state = self.cyther.generateCypher_id(self.qparser.jsondata)
...
if __name__ == "__main__":
    qe = QuestionQuery()
    queryparam = '{"QuestionId":"6F070098-E62B-429E-8604-556EDCDC6C28","ItemBankId":"805AAF07-1FFF-4B96-A470-A132AE776C87","Count":2}'
